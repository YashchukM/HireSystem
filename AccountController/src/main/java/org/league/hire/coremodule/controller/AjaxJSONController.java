...
public class AjaxJSONController {
	...
	public @ResponseBody String uploadUserImage(MultipartHttpServletRequest request, Principal principal) {
		String result = "";
	...
	public @ResponseBody String uploadItemImage(MultipartHttpServletRequest request, Principal principal) {
		String result = "";
	...
	public @ResponseBody String changeUsersInfoRequest(HttpServletRequest request, Principal principal) {
		String result = "";
...
/*			address = userDet.getAddress();
	...
	public @ResponseBody String changeItemsInfoRequest(HttpServletRequest request, Principal principal) {
		String result = "";
	...
	public @ResponseBody String deleteItemRequest(HttpServletRequest request, Principal principal) {
		String result = "";
	...
	public @ResponseBody String confirmItemReturningRequest(HttpServletRequest request, Principal principal) {
		String result = "";
	...
	public @ResponseBody String confirmItemLendingRequest(HttpServletRequest request, Principal principal) {
		String result = "";
